...
class _MySampleStateState extends State<MySampleState> {
                ...
                customCardTypeIcons: <CustomCardTypeIcon>[
                  CustomCardTypeIcon(
                    ...
                    cardImage: Image.network(
                      'https://logos-world.net/wp-content/uploads/2020/09/Mastercard-Symbol.jpg',
                      height: 48,
                      width: 48,
                    ),
                  ),
  ...
  void _onValidate() {
    if (formKey.currentState!.validate()) {
      BookedCubit.get(context).changeAddCard();
      print(BookedCubit.get(context).addCard);
      BookedCubit.get(context).next();
